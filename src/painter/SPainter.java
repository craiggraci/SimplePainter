...
//        c.add(this,BorderLayout.CENTER);
     ...
     */
    public SPainter(String t,int h, int w) {
    ...
    public void fitToScreen() {
         ...
         theFrame.setSize(screenSize.width,screenSize.height);
        
    }
    
//    public SPainter(String t) {
//         Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
//         final JFrame jf = new JFrame(t);
...
//    }
    ...
    public SPainter(String t,int h, int w, int x, int y) {
        final JFrame jf = new JFrame(t);
        theFrame = jf;
        jf.setSize(h+22,w);
        jf.setLocation(x,y);
...
//        update(pg);
    ...
    public void setFontSize(int fs) {
        Font f = new Font("Dialog", Font.PLAIN, fs);
        gir.setFont(f);        
    }
    ...
    public void draw(String s) {
        ...
        FontMetrics fm = gir.getFontMetrics();
...
//
        ...
        try {
            ...
            Logger.getLogger(SPainter.class.getName()).log(Level.SEVERE, null, ex);
        }
